...
```{r openings-vs-closures}
figure_1_v_1 <- ggplot(all_museums_over_time, aes(x=year)) +
  geom_ribbon(
    aes(ymin=openings_lo_all, ymax=openings_hi_all),
    fill="blue",alpha=0.3
  ) +
  geom_ribbon(
    aes(ymin=closures_lo_all, ymax=closures_hi_all),
    fill="red", alpha=0.3
  ) +
  geom_line(
    aes(y=openings_all, colour="Openings"), size=1, alpha=0.7
  ) +
  geom_line(
    aes(y=closures_all, colour="Closures"), size=1, alpha=0.7
  ) +
  scale_x_continuous(
    expand=c(0,0),
    limits=c(1960, 2026),
  ...
  labs(
    title = "Museum openings and closures (1960-2025)",
    subtitle = "with 95% confidence intervals",
    y = "Number of openings/closures",
    x = "Year"
  ) +
  theme_minimal() +
  theme(legend.position=c(0.85, 0.9))
#ggsave("figures/fig01v1.svg", figure_1_v_1, width=output_width, height=output_height, units=output_units, bg="white")
figure_1_v_1
```

```{r openings-vs-closures-smooth}
figure_1_v_2 <- ggplot(all_museums_over_time, aes(x=year)) +
  geom_smooth(
  ...
  theme_minimal() +
  theme(legend.position=c(0.85, 0.9))
ggsave("figures/fig01.svg", figure_1_v_2, width=output_width, height=output_height, units=output_units, bg="white")
figure_1_v_2
```

### Figure 2
Rate of museum openings and closures in the UK 1960-2025
```{r opening-vs-closure-rate}
figure_2_v_1 <- ggplot(all_museums_over_time, aes(x=year)) +
  geom_ribbon(
    aes(ymin=opening_rate_lo_all, ymax=opening_rate_hi_all),
    fill="blue",alpha=0.3
  ) +
  geom_ribbon(
    aes(ymin=closure_rate_lo_all, ymax=closure_rate_hi_all),
    fill="red", alpha=0.3
  ) +
  geom_line(
    aes(y=opening_rate_all, colour="Opening rate"), size=1, alpha=0.7
  ) +
  geom_line(
    aes(y=closure_rate_all, colour="Closure rate"), size=1, alpha=0.7
  ) +
  scale_x_continuous(
    expand=c(0,0),
    limits=c(1960, 2026),
  ...
  guides(colour=guide_legend(reverse=TRUE)) +
  labs(
    title = "Museum opening and closure rates (1960-2025)",
    subtitle = "with 95% confidence intervals",
  ...
  theme_minimal() +
  theme(legend.position=c(0.85, 0.9))
#ggsave("figures/fig02v1.svg", figure_2_v_1, width=output_width, height=output_height, units=output_units, bg="white")
figure_2_v_1
```

```{r openings-vs-closures-rate-smooth}
figure_2_v_2 <- ggplot(all_museums_over_time, aes(x=year)) +
  geom_smooth(
  ...
  theme_minimal() +
  theme(legend.position=c(0.85, 0.9))
ggsave("figures/fig02.svg", figure_2_v_2, width=output_width, height=output_height, units=output_units, bg="white")
figure_2_v_2
```

### Figure 5
Rates of closure for independent, local authority, and private museums in the UK 2000-25
```{r closure-rates-governance}
figure_5_v_1 <- ggplot(
  ...
  geom_ribbon(
    aes(
      ymin=closure_rate_lo,
      ymax=closure_rate_hi,
      fill=governance_broad
    ),
    alpha=0.3
  ) +
  geom_line(
    aes(y=closure_rate, colour=governance_broad), size=1, alpha=0.7
  ) +
  scale_x_continuous(
    expand=c(0,0),
    limits=c(1999, 2026),
  ...
  labs(
    title = "Museum opening and closure rates (2000-2025), selected governance types",
    subtitle = "with 95% confidence intervals",
...
#ggsave("figures/fig05v1.svg", width=output_width, height=output_height, units=output_units, bg="white")
figure_5_v_1
```
...
figure_5_v_2 <- ggplot(
  ...
  theme_minimal() +
  theme(legend.position=c(0.8, 0.9))
ggsave("figures/fig05.svg", figure_5_v_2, width=output_width, height=output_height, units=output_units, bg="white")
figure_5_v_2
```

### Figure 16
The year of foundation of museums open in the UK in 2000, the colour blocks indicate five-year intervals
```{r founding-year-histogram-2000}
figure_16_v_1 <- ggplot(
  museums |>
    filter(is.na(year_closed_sampled) | year_closed_sampled > 2000, year_opened_2 < 2000),
  aes(
    x=year_opened_sampled
  )
) +
  geom_histogram(binwidth=5, boundary=2000, closed="left", fill="#004D40", alpha=0.7) +
  scale_x_continuous(
    breaks=seq(1600, 2000, 50),
    minor_breaks=seq(1600, 2000, 10),
    limits=c(1600, 2000)
  ) +
  labs(
    title="Founding year of museums open in 2000",
    y="Number of museums",
    x="Founding year"
  ) +
  standard_bars_theme
ggsave("figures/fig16.svg", figure_16_v_1, width=output_width, height=output_height, units=output_units, bg="white")
figure_16_v_1
```

```{r founding-year-histogram-2000-shortened}
figure_16_v_2 <- ggplot(
  museums |>
    filter(is.na(year_closed_sampled) | year_closed_sampled > 2000, year_opened_2 < 2000),
  aes(
    x=year_opened_sampled
  ...
  standard_bars_theme
#ggsave("figures/fig16v2.svg", width=output_width, height=output_height, units=output_units, bg="white")
figure_16_v_2
```

### Figure 17
The year of foundation of museums open in the UK in 2025 grouped by five-year intervals
```{r founding-year-histogram-2025}
figure_17_v_1 <- ggplot(
  museums |>
  ...
  geom_histogram(binwidth=5, boundary=2025, closed="left", fill="#004D40", alpha=0.7) +
  scale_x_continuous(
    breaks=seq(1600, 2025, 50),
    minor_breaks=seq(1600, 2025, 10),
    limits=c(1600, 2025)
  ) +
  labs(
    title="Founding year of museums open in 2025",
    y="Number of museums",
    x="Founding year"
  ) +
  standard_bars_theme
ggsave("figures/fig17.svg", figure_17_v_1, width=output_width, height=output_height, units=output_units, bg="white")
figure_17_v_1
```

```{r founding-year-histogram-2025-shortened}
figure_17_v_2 <- ggplot(
  museums |>
    filter(is.na(year_closed_sampled)),
  aes(
    x=year_opened_sampled
  ...
  standard_bars_theme
#ggsave("figures/fig17v2.svg", width=output_width, height=output_height, units=output_units, bg="white")
figure_17_v_2
```
### Figure 18
...
figure_18 <- ggplot(haz_by_band_ci |> filter(!is.na(age_band)), aes(age_band, hazard_rate_k, group=1)) +
